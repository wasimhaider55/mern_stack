...
// const ideas = products.products.map((n) => {
//     return n.id
// })
// console.log(ideas);

// // part 1 :  Average rating and price of all products
// const [price,rating] = products.products;
// const sum = products.products.reduce((p,c) =>{
//     return p + c.rating;
// },0);
// const avgRating = sum/products.products.length;
// // average rating 
// console.log(avgRating);
// const prices =products.products.map((n) =>{
//     return n.price
// });
...
//  // // part 2 : All brand names along with Titles and Unit prices
//  const [brand,title,price] = products.products;
//  const all = products.products.map(({brand,title,price,}) =>{
//      return console.log(` Title ${title} , Brand ${brand} , Price ${price}  `);
//  });


// // // part 3 :  print all categories 
// const [category] = products.products;
// products.products.map(({category}) => console.log(category));

// // // part 4 :  print title , id , prices and images (each individual images)
// const [title, id, price, images] = products.products;
// products.products.map(({ title, id, price, images }) => {
